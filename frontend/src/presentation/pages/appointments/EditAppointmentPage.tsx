...
import type { AppointmentFormData } from '@shared/schemas/appointment.schema'
import { useAppointment, useUpdateAppointment, useCheckAppointmentAvailability } from '@presentation/hooks/useAppointments'
...
export const EditAppointmentPage: React.FC = () => {
  ...
  if (loadingAppointment || loadingPatients || loadingVeterinarians) {
    return (
  ...
  if (!appointment) {
    return (
      <div className="flex flex-col items-center justify-center h-96 space-y-4">
        ...
        <Button onClick={() => navigate(ROUTES.APPOINTMENTS.LIST)}>
    ...
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        <Button
          variant="ghost"
          size="icon"
          onClick={() => navigate(ROUTES.APPOINTMENTS.VIEW(appointmentId))}
        >
