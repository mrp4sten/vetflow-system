...
export const CreateMedicalRecordPage: React.FC = () => {
  ...
  const onSubmit = async (data: MedicalRecordFormData) => {
    try {
      const record = await createRecord.mutateAsync(data)
      navigate(ROUTES.MEDICAL_RECORDS.VIEW(record.id))
    } catch (error) {
          ...
          <div className="grid gap-6 max-w-4xl">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Select patient and record details
                </CardDescription>
              </CardHeader>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Enter clinical findings and diagnosis
                </CardDescription>
              </CardHeader>
